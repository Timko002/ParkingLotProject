...
void MapPanel::makePanel()
{
	...
	mapPanelWidget.add(new pngButton(MapPanel::getContext(), 1002, wxBitmap("images/mapmarkerA.PNG", wxBITMAP_TYPE_PNG), wxPoint(330, 355), wxSize(41, 50), "LotA"));
	mapPanelWidget.add(new pngButton(MapPanel::getContext(), 1003, wxBitmap("images/mapmarkerB.PNG", wxBITMAP_TYPE_PNG), wxPoint(320, 450), wxSize(41, 50), "LotB"));
	mapPanelWidget.add(new pngButton(MapPanel::getContext(), 1004, wxBitmap("images/mapmarkerC.PNG", wxBITMAP_TYPE_PNG), wxPoint(320, 550), wxSize(41, 50), "LotC"));
	mapPanelWidget.add(new pngButton(MapPanel::getContext(), 1005, wxBitmap("images/mapmarkerD.PNG", wxBITMAP_TYPE_PNG), wxPoint(395, 630), wxSize(41, 50), "LotD"));
	mapPanelWidget.add(new pngButton(MapPanel::getContext(), 1006, wxBitmap("images/mapmarkerE.PNG", wxBITMAP_TYPE_PNG), wxPoint(520, 660), wxSize(41, 50), "LotE"));
	mapPanelWidget.add(new pngButton(MapPanel::getContext(), 1007, wxBitmap("images/mapmarkerF.PNG", wxBITMAP_TYPE_PNG), wxPoint(660, 660), wxSize(41, 50), "LotF"));
	mapPanelWidget.add(new pngButton(MapPanel::getContext(), 1008, wxBitmap("images/mapmarkerG.PNG", wxBITMAP_TYPE_PNG), wxPoint(770, 660), wxSize(41, 50), "LotG"));
	mapPanelWidget.add(new pngButton(MapPanel::getContext(), 1009, wxBitmap("images/mapmarkerH.PNG", wxBITMAP_TYPE_PNG), wxPoint(770, 560), wxSize(41, 50), "LotH"));
	mapPanelWidget.add(new pngButton(MapPanel::getContext(), 1010, wxBitmap("images/mapmarkerI.PNG", wxBITMAP_TYPE_PNG), wxPoint(760, 250), wxSize(41, 50), "LotI"));
	mapPanelWidget.add(new pngButton(MapPanel::getContext(), 1011, wxBitmap("images/mapmarkerJ.PNG", wxBITMAP_TYPE_PNG), wxPoint(700, 190), wxSize(41, 50), "LotJ"));
	mapPanelWidget.add(new TextButton(MapPanel::getContext(), 20, "Log Out", wxPoint(75, 750), wxSize(75, 30), "Logout"));
	
	// set some extras widgets
	...
	for (wxWindowList::Node* node = children.GetFirst(); node; node = node->GetNext())
	{
		...
		else if (current->GetName().substr(0, 8) == "LDetails")
		{
